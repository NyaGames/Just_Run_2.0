class Chaser{
    ...
    crear(chaser){
        chaser = game.add.sprite(chaser.positionX, chaser.positionY, 'chaser');
        game.physics.enable(chaser, Phaser.Physics.ARCADE);
        chaser.body.collideWorldBounds = true;
        chaser.body.maxVelocity.setTo(400, 400 * 10);
        chaser.body.drag.setTo(3600, 0);
